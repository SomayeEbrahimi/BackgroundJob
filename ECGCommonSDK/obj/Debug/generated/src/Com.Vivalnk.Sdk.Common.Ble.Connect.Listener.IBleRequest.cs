...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Listener {
	...
	public partial interface IBleRequest : IJavaObject, IJavaPeerable {
		...
		[Register ("cancel", "()V", "GetCancelHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IBleRequestInvoker, ECGCommonSDK")]
		void Cancel ();
		...
		[Register ("process", "(Lcom/vivalnk/sdk/common/ble/connect/listener/IBleDispatcher;)V", "GetProcess_Lcom_vivalnk_sdk_common_ble_connect_listener_IBleDispatcher_Handler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IBleRequestInvoker, ECGCommonSDK")]
	...
	internal partial class IBleRequestInvoker : global::Java.Lang.Object, IBleRequest {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/listener/IBleRequest", typeof (IBleRequestInvoker));
