...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Request {
	...
	public partial class DescriptorRead : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.BaseIORequest {
		...
		public partial interface IDescriptorReadListener : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IRequestCallback {
			...
			[Register ("onComplete", "(Landroid/bluetooth/BluetoothGattDescriptor;I[B)V", "GetOnComplete_Landroid_bluetooth_BluetoothGattDescriptor_IarrayBHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Request.DescriptorRead/IDescriptorReadListenerInvoker, ECGCommonSDK")]
		...
		internal partial class IDescriptorReadListenerInvoker : global::Java.Lang.Object, IDescriptorReadListener {
			...
			static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/request/DescriptorRead$DescriptorReadListener", typeof (IDescriptorReadListenerInvoker));
...
#pragma warning restore 0169
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/request/DescriptorRead", typeof (DescriptorRead));
		...
		{
			const string __id = "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/DescriptorRead$DescriptorReadListener;Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;)V";
