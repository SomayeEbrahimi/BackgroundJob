...
namespace Com.Vivalnk.Sdk.Common.Eventbus.Util {
	...
	public partial class ErrorDialogManager : global::Java.Lang.Object {
		...
		public static global::Com.Vivalnk.Sdk.Common.Eventbus.Util.ErrorDialogFragmentFactory Factory {
			get {
				const string __id = "factory.Lcom/vivalnk/sdk/common/eventbus/util/ErrorDialogFragmentFactory;";

				var __v = _members.StaticFields.GetObjectValue (__id);
				return global::Java.Lang.Object.GetObject<global::Com.Vivalnk.Sdk.Common.Eventbus.Util.ErrorDialogFragmentFactory> (__v.Handle, JniHandleOwnership.TransferLocalRef);
			}
			set {
				const string __id = "factory.Lcom/vivalnk/sdk/common/eventbus/util/ErrorDialogFragmentFactory;";
		...
		public partial class HoneycombManagerFragment : global::Android.App.Fragment {
			...
			static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/eventbus/util/ErrorDialogManager$HoneycombManagerFragment", typeof (HoneycombManagerFragment));
			...
			{
				const string __id = "attachTo.(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [4];
					__args [0] = new JniArgumentValue ((activity == null) ? IntPtr.Zero : ((global::Java.Lang.Object) activity).Handle);
					__args [1] = new JniArgumentValue ((executionScope == null) ? IntPtr.Zero : ((global::Java.Lang.Object) executionScope).Handle);
					__args [2] = new JniArgumentValue (finishAfterDialog);
					__args [3] = new JniArgumentValue ((argumentsForErrorDialog == null) ? IntPtr.Zero : ((global::Java.Lang.Object) argumentsForErrorDialog).Handle);
...
#pragma warning restore 0169
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/eventbus/util/ErrorDialogManager", typeof (ErrorDialogManager));
		internal static IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
