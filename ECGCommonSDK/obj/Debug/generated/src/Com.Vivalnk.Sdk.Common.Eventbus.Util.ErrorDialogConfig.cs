...
namespace Com.Vivalnk.Sdk.Common.Eventbus.Util {
	...
	public partial class ErrorDialogConfig : global::Java.Lang.Object {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/eventbus/util/ErrorDialogConfig", typeof (ErrorDialogConfig));
...
#pragma warning restore 0169
		...
		{
			const string __id = "addMapping.(Ljava/lang/Class;I)Lcom/vivalnk/sdk/common/eventbus/util/ErrorDialogConfig;";
			try {
				...
				return global::Java.Lang.Object.GetObject<global::Com.Vivalnk.Sdk.Common.Eventbus.Util.ErrorDialogConfig> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		{
			const string __id = "setEventBus.(Lcom/vivalnk/sdk/common/eventbus/EventBus;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
