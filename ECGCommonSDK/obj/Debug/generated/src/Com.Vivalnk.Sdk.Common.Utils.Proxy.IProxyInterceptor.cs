...
namespace Com.Vivalnk.Sdk.Common.Utils.Proxy {
	...
	public partial interface IProxyInterceptor : IJavaObject, IJavaPeerable {
		...
		[Register ("onIntercept", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Z", "GetOnIntercept_Ljava_lang_Object_Ljava_lang_reflect_Method_arrayLjava_lang_Object_Handler:Com.Vivalnk.Sdk.Common.Utils.Proxy.IProxyInterceptorInvoker, ECGCommonSDK")]
	...
	internal partial class IProxyInterceptorInvoker : global::Java.Lang.Object, IProxyInterceptor {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/utils/proxy/ProxyInterceptor", typeof (IProxyInterceptorInvoker));
