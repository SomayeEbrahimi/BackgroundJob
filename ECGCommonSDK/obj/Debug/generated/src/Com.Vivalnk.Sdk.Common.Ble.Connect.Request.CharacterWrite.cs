...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Request {
	...
	public partial class CharacterWrite : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.BaseIORequest {
		...
		public partial interface ICharacterWriteListener : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IRequestCallback {
			...
			[Register ("onComplete", "(Landroid/bluetooth/BluetoothGattCharacteristic;I[B)V", "GetOnComplete_Landroid_bluetooth_BluetoothGattCharacteristic_IarrayBHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Request.CharacterWrite/ICharacterWriteListenerInvoker, ECGCommonSDK")]
		...
		internal partial class ICharacterWriteListenerInvoker : global::Java.Lang.Object, ICharacterWriteListener {
			...
			static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/request/CharacterWrite$CharacterWriteListener", typeof (ICharacterWriteListenerInvoker));
...
#pragma warning restore 0169
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/request/CharacterWrite", typeof (CharacterWrite));
		...
		{
			const string __id = "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWrite$CharacterWriteListener;Ljava/util/UUID;Ljava/util/UUID;[B)V";
