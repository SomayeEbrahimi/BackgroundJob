...
namespace Com.Vivalnk.Sdk.Common.Ble.Scan {
	...
	public partial interface IScanOperation : IJavaObject, IJavaPeerable {
		...
		[Register ("startScan", "(Lcom/vivalnk/sdk/common/ble/scan/ScanOptions;Lcom/vivalnk/sdk/common/ble/scan/BleScanListener;)V", "GetStartScan_Lcom_vivalnk_sdk_common_ble_scan_ScanOptions_Lcom_vivalnk_sdk_common_ble_scan_BleScanListener_Handler:Com.Vivalnk.Sdk.Common.Ble.Scan.IScanOperationInvoker, ECGCommonSDK")]
		...
		[Register ("stopScanning", "()V", "GetStopScanningHandler:Com.Vivalnk.Sdk.Common.Ble.Scan.IScanOperationInvoker, ECGCommonSDK")]
		void StopScanning ();
	...
	internal partial class IScanOperationInvoker : global::Java.Lang.Object, IScanOperation {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/scan/IScanOperation", typeof (IScanOperationInvoker));
