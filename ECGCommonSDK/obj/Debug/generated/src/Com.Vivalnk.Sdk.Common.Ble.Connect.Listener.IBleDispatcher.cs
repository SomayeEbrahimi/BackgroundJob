...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Listener {
	...
	public partial interface IBleDispatcher : IJavaObject, IJavaPeerable {
		...
		[Register ("onRequestFinsh", "(Lcom/vivalnk/sdk/common/ble/connect/base/BaseIORequest;)V", "GetOnRequestFinsh_Lcom_vivalnk_sdk_common_ble_connect_base_BaseIORequest_Handler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IBleDispatcherInvoker, ECGCommonSDK")]
	...
	internal partial class IBleDispatcherInvoker : global::Java.Lang.Object, IBleDispatcher {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/listener/IBleDispatcher", typeof (IBleDispatcherInvoker));
