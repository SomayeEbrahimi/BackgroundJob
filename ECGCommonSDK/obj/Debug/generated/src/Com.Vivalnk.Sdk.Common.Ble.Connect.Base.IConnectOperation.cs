...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Base {
	...
	public partial interface IConnectOperation : IJavaObject, IJavaPeerable {
		...
		bool IsConnected {
			...
			[Register ("isConnected", "()Z", "GetIsConnectedHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IConnectOperationInvoker, ECGCommonSDK")] get;
		}
		...
		bool IsConnecting {
			...
			[Register ("isConnecting", "()Z", "GetIsConnectingHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IConnectOperationInvoker, ECGCommonSDK")] get;
		}
	...
	internal partial class IConnectOperationInvoker : global::Java.Lang.Object, IConnectOperation {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/common/ble/connect/base/IConnectOperation", typeof (IConnectOperationInvoker));
