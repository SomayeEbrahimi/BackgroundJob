...
namespace Org.Apache.Commons.Lang3.Text.Translate {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.lang3.text.translate']/class[@name='LookupTranslator']"
	[ObsoleteAttribute (@"This class is obsoleted in this android platform")]
	[global::Android.Runtime.Register ("org/apache/commons/lang3/text/translate/LookupTranslator", DoNotGenerateAcw=true)]
	public partial class LookupTranslator : global::Org.Apache.Commons.Lang3.Text.Translate.CharSequenceTranslator {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/apache/commons/lang3/text/translate/LookupTranslator", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LookupTranslator); }
		}

		protected LookupTranslator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayarrayLjava_lang_CharSequence_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.lang3.text.translate']/class[@name='LookupTranslator']/constructor[@name='LookupTranslator' and count(parameter)=1 and parameter[1][@type='java.lang.CharSequence[]...']]"
		[Register (".ctor", "([[Ljava/lang/CharSequence;)V", "")]
		public unsafe LookupTranslator (params global::Java.Lang.ICharSequence[][] lookup)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_lookup = JNIEnv.NewArray (lookup);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_lookup);
				if (((object) this).GetType () != typeof (LookupTranslator)) {
					SetHandle (
				...
				if (id_ctor_arrayarrayLjava_lang_CharSequence_ == IntPtr.Zero)
					id_ctor_arrayarrayLjava_lang_CharSequence_ = JNIEnv.GetMethodID (class_ref, "<init>", "([[Ljava/lang/CharSequence;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_arrayarrayLjava_lang_CharSequence_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_arrayarrayLjava_lang_CharSequence_, __args);
			} finally {
				if (lookup != null) {
					JNIEnv.CopyArray (native_lookup, lookup);
					JNIEnv.DeleteLocalRef (native_lookup);
				}
			}
		}

		[Register (".ctor", "([[Ljava/lang/CharSequence;)V", "")]
		public unsafe LookupTranslator (params string[][] lookup)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Apache.Commons.Lang3.Text.Translate.LookupTranslator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.apache.commons.lang3.text.translate']/class[@name='LookupTranslator']/method[@name='translate' and count(parameter)=3 and parameter[1][@type='java.lang.CharSequence'] and parameter[2][@type='int'] and parameter[3][@type='java.io.Writer']]"
