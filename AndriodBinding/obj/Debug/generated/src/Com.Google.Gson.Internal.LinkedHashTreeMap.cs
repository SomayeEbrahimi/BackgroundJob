...
namespace Com.Google.Gson.Internal {
	...
	public sealed partial class LinkedHashTreeMap : global::Java.Util.AbstractMap, global::Java.IO.ISerializable {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/gson/internal/LinkedHashTreeMap", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LinkedHashTreeMap); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (LinkedHashTreeMap)) {
					SetHandle (
