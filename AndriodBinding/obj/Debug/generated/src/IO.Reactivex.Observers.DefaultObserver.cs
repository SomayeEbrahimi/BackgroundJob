...
namespace IO.Reactivex.Observers {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DefaultObserver']"
	[global::Android.Runtime.Register ("io/reactivex/observers/DefaultObserver", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public abstract partial class DefaultObserver : global::Java.Lang.Object, global::IO.Reactivex.IObserver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/observers/DefaultObserver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DefaultObserver); }
		}

		protected DefaultObserver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DefaultObserver']/constructor[@name='DefaultObserver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DefaultObserver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (DefaultObserver)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DefaultObserver']/method[@name='cancel' and count(parameter)=0]"
		[Register ("cancel", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Observers.DefaultObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnStart ();
		}
#pragma warning restore 0169

		static IntPtr id_onStart;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DefaultObserver']/method[@name='onStart' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DefaultObserver']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
...
#pragma warning restore 0169
	...
	[global::Android.Runtime.Register ("io/reactivex/observers/DefaultObserver", DoNotGenerateAcw=true)]
	internal partial class DefaultObserverInvoker : DefaultObserver, global::IO.Reactivex.IObserver {

		public DefaultObserverInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (DefaultObserverInvoker); }
		}
