...
namespace Com.Google.Gson.Annotations {
	...
	public partial interface ISerializedName : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("alternate", "()[Ljava/lang/String;", "GetAlternateHandler:Com.Google.Gson.Annotations.ISerializedNameInvoker, AndriodBinding")]
		string[] Alternate ();
		...
		[Register ("value", "()Ljava/lang/String;", "GetValueHandler:Com.Google.Gson.Annotations.ISerializedNameInvoker, AndriodBinding")]
		string Value ();
...
#pragma warning disable 0169
		static Delegate GetAlternateHandler ()
		{
			if (cb_alternate == null)
				cb_alternate = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Alternate);
			return cb_alternate;
		}

		static IntPtr n_Alternate (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Google.Gson.Annotations.ISerializedName> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
