...
namespace Com.Google.Gson.Annotations {
	...
	public partial interface ISince : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("value", "()D", "GetValueHandler:Com.Google.Gson.Annotations.ISinceInvoker, AndriodBinding")]
		double Value ();
...
#pragma warning disable 0169
		...
		{
			if (cb_value == null)
				cb_value = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_D) n_Value);
			return cb_value;
		}

		static double n_Value (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Google.Gson.Annotations.ISince> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Value ();
		}
