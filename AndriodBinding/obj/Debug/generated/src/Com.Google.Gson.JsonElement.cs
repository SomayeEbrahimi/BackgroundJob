...
#pragma warning disable 0169
		static Delegate GetGetAsBigDecimalHandler ()
		{
			if (cb_getAsBigDecimal == null)
				cb_getAsBigDecimal = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsBigDecimal);
			return cb_getAsBigDecimal;
		}

		static IntPtr n_GetAsBigDecimal (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Google.Gson.JsonElement> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetAsBigIntegerHandler ()
		{
			if (cb_getAsBigInteger == null)
				cb_getAsBigInteger = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsBigInteger);
...
#pragma warning disable 0169
		static Delegate GetGetAsByteHandler ()
		{
			if (cb_getAsByte == null)
				cb_getAsByte = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_B) n_GetAsByte);
			return cb_getAsByte;
		}
...
#pragma warning disable 0169
		static Delegate GetGetAsCharacterHandler ()
		{
			if (cb_getAsCharacter == null)
				cb_getAsCharacter = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_C) n_GetAsCharacter);
...
#pragma warning disable 0169
		static Delegate GetGetAsDoubleHandler ()
		{
			if (cb_getAsDouble == null)
				cb_getAsDouble = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_D) n_GetAsDouble);
...
#pragma warning disable 0169
		static Delegate GetGetAsFloatHandler ()
		{
			if (cb_getAsFloat == null)
				cb_getAsFloat = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_F) n_GetAsFloat);
...
#pragma warning disable 0169
		...
		{
			if (cb_getAsInt == null)
				cb_getAsInt = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetAsInt);
			return cb_getAsInt;
		}
...
#pragma warning disable 0169
		static Delegate GetGetAsJsonArrayHandler ()
		{
			if (cb_getAsJsonArray == null)
				cb_getAsJsonArray = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsJsonArray);
...
#pragma warning disable 0169
		static Delegate GetGetAsJsonNullHandler ()
		{
			if (cb_getAsJsonNull == null)
				cb_getAsJsonNull = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsJsonNull);
...
#pragma warning disable 0169
		static Delegate GetGetAsJsonObjectHandler ()
		{
			if (cb_getAsJsonObject == null)
				cb_getAsJsonObject = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsJsonObject);
...
#pragma warning disable 0169
		static Delegate GetGetAsJsonPrimitiveHandler ()
		{
			if (cb_getAsJsonPrimitive == null)
				cb_getAsJsonPrimitive = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsJsonPrimitive);
...
#pragma warning disable 0169
		static Delegate GetGetAsLongHandler ()
		{
			if (cb_getAsLong == null)
				cb_getAsLong = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_GetAsLong);
			return cb_getAsLong;
		}
...
#pragma warning disable 0169
		static Delegate GetGetAsNumberHandler ()
		{
			if (cb_getAsNumber == null)
				cb_getAsNumber = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsNumber);
...
#pragma warning disable 0169
		static Delegate GetGetAsShortHandler ()
		{
			if (cb_getAsShort == null)
				cb_getAsShort = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_S) n_GetAsShort);
...
#pragma warning disable 0169
		static Delegate GetGetAsStringHandler ()
		{
			if (cb_getAsString == null)
				cb_getAsString = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetAsString);
...
#pragma warning disable 0169
		static Delegate GetIsJsonArrayHandler ()
		{
			if (cb_isJsonArray == null)
				cb_isJsonArray = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_IsJsonArray);
...
#pragma warning disable 0169
		static Delegate GetIsJsonNullHandler ()
		{
			if (cb_isJsonNull == null)
				cb_isJsonNull = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_IsJsonNull);
...
#pragma warning disable 0169
		static Delegate GetIsJsonObjectHandler ()
		{
			if (cb_isJsonObject == null)
				cb_isJsonObject = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_IsJsonObject);
...
#pragma warning disable 0169
		static Delegate GetIsJsonPrimitiveHandler ()
		{
			if (cb_isJsonPrimitive == null)
				cb_isJsonPrimitive = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_IsJsonPrimitive);
...
#pragma warning disable 0169
		...
		{
			if (cb_deepCopy == null)
				cb_deepCopy = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_DeepCopy);
			return cb_deepCopy;
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.gson']/class[@name='JsonElement']/method[@name='deepCopy' and count(parameter)=0]"
		[Register ("deepCopy", "()Lcom/google/gson/JsonElement;", "GetDeepCopyHandler")]
		public abstract global::Com.Google.Gson.JsonElement DeepCopy ();
	...
	internal partial class JsonElementInvoker : JsonElement {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.gson']/class[@name='JsonElement']/method[@name='deepCopy' and count(parameter)=0]"
		[Register ("deepCopy", "()Lcom/google/gson/JsonElement;", "GetDeepCopyHandler")]
		public override unsafe global::Com.Google.Gson.JsonElement DeepCopy ()
		{
			if (id_deepCopy == IntPtr.Zero)
				id_deepCopy = JNIEnv.GetMethodID (class_ref, "deepCopy", "()Lcom/google/gson/JsonElement;");
			try {
				return global::Java.Lang.Object.GetObject<global::Com.Google.Gson.JsonElement> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_deepCopy), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
