...
namespace Retrofit2.Http {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='retrofit2.http']/interface[@name='Query']"
	[Register ("retrofit2/http/Query", "", "Retrofit2.Http.IQueryInvoker")]
	public partial interface IQuery : global::Java.Lang.Annotation.IAnnotation {

		// Metadata.xml XPath method reference: path="/api/package[@name='retrofit2.http']/interface[@name='Query']/method[@name='encoded' and count(parameter)=0]"
		[Register ("encoded", "()Z", "GetEncodedHandler:Retrofit2.Http.IQueryInvoker, AndriodBinding")]
		bool Encoded ();

		// Metadata.xml XPath method reference: path="/api/package[@name='retrofit2.http']/interface[@name='Query']/method[@name='value' and count(parameter)=0]"
		[Register ("value", "()Ljava/lang/String;", "GetValueHandler:Retrofit2.Http.IQueryInvoker, AndriodBinding")]
		string Value ();

	}

	[global::Android.Runtime.Register ("retrofit2/http/Query", DoNotGenerateAcw=true)]
	internal partial class IQueryInvoker : global::Java.Lang.Object, IQuery {

		static IntPtr java_class_ref = JNIEnv.FindClass ("retrofit2/http/Query");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IQueryInvoker); }
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "retrofit2.http.Query"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Retrofit2.Http.IQuery> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
