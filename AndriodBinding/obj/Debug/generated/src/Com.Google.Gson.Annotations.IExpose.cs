...
namespace Com.Google.Gson.Annotations {
	...
	public partial interface IExpose : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("deserialize", "()Z", "GetDeserializeHandler:Com.Google.Gson.Annotations.IExposeInvoker, AndriodBinding")]
		bool Deserialize ();
		...
		[Register ("serialize", "()Z", "GetSerializeHandler:Com.Google.Gson.Annotations.IExposeInvoker, AndriodBinding")]
		bool Serialize ();
...
#pragma warning disable 0169
		static Delegate GetDeserializeHandler ()
		{
			if (cb_deserialize == null)
				cb_deserialize = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_Deserialize);
			return cb_deserialize;
		}

		static bool n_Deserialize (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Google.Gson.Annotations.IExpose> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetSerializeHandler ()
		{
			if (cb_serialize == null)
				cb_serialize = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_Serialize);
			return cb_serialize;
		}
