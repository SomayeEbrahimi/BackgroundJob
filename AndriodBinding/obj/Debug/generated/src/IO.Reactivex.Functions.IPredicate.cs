...
namespace IO.Reactivex.Functions {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='io.reactivex.functions']/interface[@name='Predicate']"
	[Register ("io/reactivex/functions/Predicate", "", "IO.Reactivex.Functions.IPredicateInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public partial interface IPredicate : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.functions']/interface[@name='Predicate']/method[@name='test' and count(parameter)=1 and parameter[1][@type='T']]"
		[Register ("test", "(Ljava/lang/Object;)Z", "GetTest_Ljava_lang_Object_Handler:IO.Reactivex.Functions.IPredicateInvoker, AndriodBinding")]
		bool Test (global::Java.Lang.Object p0);

	}

	[global::Android.Runtime.Register ("io/reactivex/functions/Predicate", DoNotGenerateAcw=true)]
	internal partial class IPredicateInvoker : global::Java.Lang.Object, IPredicate {

		static IntPtr java_class_ref = JNIEnv.FindClass ("io/reactivex/functions/Predicate");
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "io.reactivex.functions.Predicate"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Functions.IPredicate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
