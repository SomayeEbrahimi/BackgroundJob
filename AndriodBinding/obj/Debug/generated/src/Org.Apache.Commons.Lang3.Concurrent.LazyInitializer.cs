...
namespace Org.Apache.Commons.Lang3.Concurrent {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.lang3.concurrent']/class[@name='LazyInitializer']"
	[global::Android.Runtime.Register ("org/apache/commons/lang3/concurrent/LazyInitializer", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public abstract partial class LazyInitializer : global::Java.Lang.Object, global::Org.Apache.Commons.Lang3.Concurrent.IConcurrentInitializer {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/apache/commons/lang3/concurrent/LazyInitializer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LazyInitializer); }
		}

		protected LazyInitializer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.lang3.concurrent']/class[@name='LazyInitializer']/constructor[@name='LazyInitializer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe LazyInitializer ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (LazyInitializer)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Apache.Commons.Lang3.Concurrent.LazyInitializer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Get ());
		}
#pragma warning restore 0169

		static IntPtr id_get;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.apache.commons.lang3.concurrent']/class[@name='LazyInitializer']/method[@name='get' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.apache.commons.lang3.concurrent']/class[@name='LazyInitializer']/method[@name='initialize' and count(parameter)=0]"
	...
	[global::Android.Runtime.Register ("org/apache/commons/lang3/concurrent/LazyInitializer", DoNotGenerateAcw=true)]
	internal partial class LazyInitializerInvoker : LazyInitializer, global::Org.Apache.Commons.Lang3.Concurrent.IConcurrentInitializer {

		public LazyInitializerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (LazyInitializerInvoker); }
		}
