...
namespace IO.Reactivex.Observers {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableCompletableObserver']"
	[global::Android.Runtime.Register ("io/reactivex/observers/DisposableCompletableObserver", DoNotGenerateAcw=true)]
	public abstract partial class DisposableCompletableObserver : global::Java.Lang.Object, global::IO.Reactivex.ICompletableObserver, global::IO.Reactivex.Disposables.IDisposable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/observers/DisposableCompletableObserver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DisposableCompletableObserver); }
		}

		protected DisposableCompletableObserver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableCompletableObserver']/constructor[@name='DisposableCompletableObserver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DisposableCompletableObserver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (DisposableCompletableObserver)) {
					SetHandle (
		...
		public unsafe bool IsDisposed {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableCompletableObserver']/method[@name='isDisposed' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableCompletableObserver']/method[@name='dispose' and count(parameter)=0]"
		[Register ("dispose", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Observers.DisposableCompletableObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnStart ();
		}
#pragma warning restore 0169

		static IntPtr id_onStart;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableCompletableObserver']/method[@name='onStart' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableCompletableObserver']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
...
#pragma warning restore 0169
	...
	[global::Android.Runtime.Register ("io/reactivex/observers/DisposableCompletableObserver", DoNotGenerateAcw=true)]
	internal partial class DisposableCompletableObserverInvoker : DisposableCompletableObserver {

		public DisposableCompletableObserverInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (DisposableCompletableObserverInvoker); }
		}
