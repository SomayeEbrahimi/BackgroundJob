...
namespace IO.Reactivex.Subjects {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']"
	[global::Android.Runtime.Register ("io/reactivex/subjects/AsyncSubject", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public sealed partial class AsyncSubject : global::IO.Reactivex.Subjects.Subject {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/subjects/AsyncSubject", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AsyncSubject); }
		}

		internal AsyncSubject (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_hasComplete;
		public override unsafe bool HasComplete {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='hasComplete' and count(parameter)=0]"
		...
		public override unsafe bool HasObservers {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='hasObservers' and count(parameter)=0]"
		...
		public override unsafe bool HasThrowable {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='hasThrowable' and count(parameter)=0]"
		...
		public unsafe bool HasValue {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='hasValue' and count(parameter)=0]"
			[Register ("hasValue", "()Z", "")]
			get {
		...
		public override unsafe global::Java.Lang.Throwable Throwable {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='getThrowable' and count(parameter)=0]"
		...
		public unsafe global::Java.Lang.Object Value {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='getValue' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='create' and count(parameter)=0]"
		[Register ("create", "()Lio/reactivex/subjects/AsyncSubject;", "")]
		[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
		public static unsafe global::IO.Reactivex.Subjects.AsyncSubject Create ()
		{
			if (id_create == IntPtr.Zero)
				id_create = JNIEnv.GetStaticMethodID (class_ref, "create", "()Lio/reactivex/subjects/AsyncSubject;");
			try {
				return global::Java.Lang.Object.GetObject<global::IO.Reactivex.Subjects.AsyncSubject> (JNIEnv.CallStaticObjectMethod  (class_ref, id_create), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}

		static IntPtr id_getValues;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='getValues' and count(parameter)=0]"
		[Obsolete (@"deprecated")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='getValues' and count(parameter)=1 and parameter[1][@type='T[]']]"
		[Obsolete (@"deprecated")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='onComplete' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='onError' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='onNext' and count(parameter)=1 and parameter[1][@type='T']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.subjects']/class[@name='AsyncSubject']/method[@name='subscribeActual' and count(parameter)=1 and parameter[1][@type='io.reactivex.Observer&lt;? super T&gt;']]"
