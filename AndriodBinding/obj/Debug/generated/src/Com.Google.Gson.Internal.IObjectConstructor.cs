...
namespace Com.Google.Gson.Internal {
	...
	public partial interface IObjectConstructor : IJavaObject {
		...
		[Register ("construct", "()Ljava/lang/Object;", "GetConstructHandler:Com.Google.Gson.Internal.IObjectConstructorInvoker, AndriodBinding")]
...
#pragma warning disable 0169
		static Delegate GetConstructHandler ()
		{
			if (cb_construct == null)
				cb_construct = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Construct);
			return cb_construct;
		}

		static IntPtr n_Construct (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Google.Gson.Internal.IObjectConstructor> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
