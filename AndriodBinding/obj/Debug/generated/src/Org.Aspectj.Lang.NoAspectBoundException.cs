...
namespace Org.Aspectj.Lang {
	...
	public partial class NoAspectBoundException : global::Java.Lang.RuntimeException {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/aspectj/lang/NoAspectBoundException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NoAspectBoundException); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (NoAspectBoundException)) {
					SetHandle (
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (native_aspectName);
				__args [1] = new JValue (inner);
				if (((object) this).GetType () != typeof (NoAspectBoundException)) {
					SetHandle (
