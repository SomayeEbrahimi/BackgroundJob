...
namespace Org.Aspectj.Runtime.Internal.Cflowstack {
	...
	public partial class ThreadStackFactoryImpl : global::Java.Lang.Object, global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackFactory {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/aspectj/runtime/internal/cflowstack/ThreadStackFactoryImpl", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ThreadStackFactoryImpl); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ThreadStackFactoryImpl)) {
					SetHandle (
