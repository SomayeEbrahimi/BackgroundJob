...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Google.Gson.Stream.JsonReader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetBeginArrayHandler ()
		{
			if (cb_beginArray == null)
				cb_beginArray = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_BeginArray);
...
#pragma warning disable 0169
		static Delegate GetBeginObjectHandler ()
		{
			if (cb_beginObject == null)
				cb_beginObject = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_BeginObject);
...
#pragma warning disable 0169
		...
		{
			if (cb_endArray == null)
				cb_endArray = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_EndArray);
			return cb_endArray;
		}
...
#pragma warning disable 0169
		static Delegate GetEndObjectHandler ()
		{
			if (cb_endObject == null)
				cb_endObject = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_EndObject);
			return cb_endObject;
		}
...
#pragma warning disable 0169
		static Delegate GetNextBooleanHandler ()
		{
			if (cb_nextBoolean == null)
				cb_nextBoolean = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_NextBoolean);
...
#pragma warning disable 0169
		static Delegate GetNextDoubleHandler ()
		{
			if (cb_nextDouble == null)
				cb_nextDouble = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_D) n_NextDouble);
...
#pragma warning disable 0169
		...
		{
			if (cb_nextInt == null)
				cb_nextInt = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_NextInt);
			return cb_nextInt;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_nextLong == null)
				cb_nextLong = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_NextLong);
			return cb_nextLong;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_nextName == null)
				cb_nextName = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_NextName);
			return cb_nextName;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_nextNull == null)
				cb_nextNull = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_NextNull);
			return cb_nextNull;
		}
...
#pragma warning disable 0169
		static Delegate GetNextStringHandler ()
		{
			if (cb_nextString == null)
				cb_nextString = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_NextString);
...
#pragma warning disable 0169
		static Delegate GetSkipValueHandler ()
		{
			if (cb_skipValue == null)
				cb_skipValue = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_SkipValue);
			return cb_skipValue;
		}
