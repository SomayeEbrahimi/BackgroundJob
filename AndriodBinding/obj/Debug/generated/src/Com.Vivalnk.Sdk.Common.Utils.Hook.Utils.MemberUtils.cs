...
namespace Com.Vivalnk.Sdk.Common.Utils.Hook.Utils {
	...
	public partial class MemberUtils : global::Java.Lang.Object {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/vivalnk/sdk/common/utils/hook/utils/MemberUtils", ref java_class_handle);
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MemberUtils)) {
					SetHandle (
