...
namespace Org.Apache.Commons.Lang3.Exception {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.lang3.exception']/class[@name='CloneFailedException']"
	[global::Android.Runtime.Register ("org/apache/commons/lang3/exception/CloneFailedException", DoNotGenerateAcw=true)]
	public partial class CloneFailedException : global::Java.Lang.RuntimeException {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/apache/commons/lang3/exception/CloneFailedException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CloneFailedException); }
		}

		protected CloneFailedException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.lang3.exception']/class[@name='CloneFailedException']/constructor[@name='CloneFailedException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe CloneFailedException (string message)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CloneFailedException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.lang3.exception']/class[@name='CloneFailedException']/constructor[@name='CloneFailedException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe CloneFailedException (string message, global::Java.Lang.Throwable cause)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.lang3.exception']/class[@name='CloneFailedException']/constructor[@name='CloneFailedException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public unsafe CloneFailedException (global::Java.Lang.Throwable cause)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
