...
namespace Okhttp3 {
	...
	public abstract class CookieJar : Java.Lang.Object {
		...
		static IntPtr NO_COOKIES_jfieldId;
		...
		public static global::Okhttp3.ICookieJar NoCookies {
			get {
				if (NO_COOKIES_jfieldId == IntPtr.Zero)
					NO_COOKIES_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "NO_COOKIES", "Lokhttp3/CookieJar;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, NO_COOKIES_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.ICookieJar> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}

		new static IntPtr class_ref = JNIEnv.FindClass ("okhttp3/CookieJar");
	}
	...
	public partial interface ICookieJar : IJavaObject {
		...
		[Register ("loadForRequest", "(Lokhttp3/HttpUrl;)Ljava/util/List;", "GetLoadForRequest_Lokhttp3_HttpUrl_Handler:Okhttp3.ICookieJarInvoker, AndriodBinding")]
		...
		[Register ("saveFromResponse", "(Lokhttp3/HttpUrl;Ljava/util/List;)V", "GetSaveFromResponse_Lokhttp3_HttpUrl_Ljava_util_List_Handler:Okhttp3.ICookieJarInvoker, AndriodBinding")]
	...
	internal partial class ICookieJarInvoker : global::Java.Lang.Object, ICookieJar {
		...
		static IntPtr java_class_ref = JNIEnv.FindClass ("okhttp3/CookieJar");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ICookieJarInvoker); }
		}
...
#pragma warning disable 0169
		static Delegate GetLoadForRequest_Lokhttp3_HttpUrl_Handler ()
		{
			if (cb_loadForRequest_Lokhttp3_HttpUrl_ == null)
				cb_loadForRequest_Lokhttp3_HttpUrl_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_L) n_LoadForRequest_Lokhttp3_HttpUrl_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.ICookieJar> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var p0 = global::Java.Lang.Object.GetObject<global::Okhttp3.HttpUrl> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public unsafe global::System.Collections.Generic.IList<global::Okhttp3.Cookie> LoadForRequest (global::Okhttp3.HttpUrl p0)
		{
			...
			var __ret = global::Android.Runtime.JavaList<global::Okhttp3.Cookie>.FromJniHandle (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_loadForRequest_Lokhttp3_HttpUrl_, __args), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
...
#pragma warning disable 0169
		static Delegate GetSaveFromResponse_Lokhttp3_HttpUrl_Ljava_util_List_Handler ()
		{
			if (cb_saveFromResponse_Lokhttp3_HttpUrl_Ljava_util_List_ == null)
				cb_saveFromResponse_Lokhttp3_HttpUrl_Ljava_util_List_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLL_V) n_SaveFromResponse_Lokhttp3_HttpUrl_Ljava_util_List_);
