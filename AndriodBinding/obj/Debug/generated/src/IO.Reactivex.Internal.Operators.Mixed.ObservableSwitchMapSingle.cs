...
namespace IO.Reactivex.Internal.Operators.Mixed {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.internal.operators.mixed']/class[@name='ObservableSwitchMapSingle']"
	[global::Android.Runtime.Register ("io/reactivex/internal/operators/mixed/ObservableSwitchMapSingle", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T", "R"})]
	public sealed partial class ObservableSwitchMapSingle : global::IO.Reactivex.Observable {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/internal/operators/mixed/ObservableSwitchMapSingle", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ObservableSwitchMapSingle); }
		}

		internal ObservableSwitchMapSingle (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lio_reactivex_Observable_Lio_reactivex_functions_Function_Z;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.internal.operators.mixed']/class[@name='ObservableSwitchMapSingle']/constructor[@name='ObservableSwitchMapSingle' and count(parameter)=3 and parameter[1][@type='io.reactivex.Observable&lt;T&gt;'] and parameter[2][@type='io.reactivex.functions.Function&lt;? super T, ? extends io.reactivex.SingleSource&lt;? extends R&gt;&gt;'] and parameter[3][@type='boolean']]"
		[Register (".ctor", "(Lio/reactivex/Observable;Lio/reactivex/functions/Function;Z)V", "")]
		public unsafe ObservableSwitchMapSingle (global::IO.Reactivex.Observable source, global::IO.Reactivex.Functions.IFunction mapper, bool delayErrors)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ObservableSwitchMapSingle)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.operators.mixed']/class[@name='ObservableSwitchMapSingle']/method[@name='subscribeActual' and count(parameter)=1 and parameter[1][@type='io.reactivex.Observer&lt;? super R&gt;']]"
