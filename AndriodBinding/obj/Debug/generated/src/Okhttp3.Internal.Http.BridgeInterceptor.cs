...
namespace Okhttp3.Internal.Http {
	...
	public sealed partial class BridgeInterceptor : global::Java.Lang.Object, global::Okhttp3.IInterceptor {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("okhttp3/internal/http/BridgeInterceptor", ref java_class_handle);
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (BridgeInterceptor)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lokhttp3/CookieJar;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Lokhttp3/CookieJar;)V", __args);
					return;
				}

				if (id_ctor_Lokhttp3_CookieJar_ == IntPtr.Zero)
					id_ctor_Lokhttp3_CookieJar_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lokhttp3/CookieJar;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lokhttp3_CookieJar_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Lokhttp3_CookieJar_, __args);
			} finally {
			}
		}
