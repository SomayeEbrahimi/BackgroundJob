...
namespace Com.Google.Gson {
	...
	public sealed partial class JsonNull : global::Com.Google.Gson.JsonElement {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.gson']/class[@name='JsonNull']/method[@name='deepCopy' and count(parameter)=0]"
		[Register ("deepCopy", "()Lcom/google/gson/JsonNull;", "")]
		public unsafe global::Com.Google.Gson.JsonNull DeepCopy ()
		{
			if (id_deepCopy == IntPtr.Zero)
				id_deepCopy = JNIEnv.GetMethodID (class_ref, "deepCopy", "()Lcom/google/gson/JsonNull;");
			try {
				return global::Java.Lang.Object.GetObject<global::Com.Google.Gson.JsonNull> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_deepCopy), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
