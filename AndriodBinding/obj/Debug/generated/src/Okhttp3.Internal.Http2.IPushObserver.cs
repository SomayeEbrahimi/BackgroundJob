...
namespace Okhttp3.Internal.Http2 {
		...
		public static global::Okhttp3.Internal.Http2.IPushObserver Cancel {
			get {
				if (CANCEL_jfieldId == IntPtr.Zero)
					CANCEL_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "CANCEL", "Lokhttp3/internal/http2/PushObserver;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, CANCEL_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.IPushObserver> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}

		new static IntPtr class_ref = JNIEnv.FindClass ("okhttp3/internal/http2/PushObserver");
	}
	...
	public partial interface IPushObserver : IJavaObject {
		...
		[Register ("onHeaders", "(ILjava/util/List;Z)Z", "GetOnHeaders_ILjava_util_List_ZHandler:Okhttp3.Internal.Http2.IPushObserverInvoker, AndriodBinding")]
		...
		[Register ("onRequest", "(ILjava/util/List;)Z", "GetOnRequest_ILjava_util_List_Handler:Okhttp3.Internal.Http2.IPushObserverInvoker, AndriodBinding")]
		...
		[Register ("onReset", "(ILokhttp3/internal/http2/ErrorCode;)V", "GetOnReset_ILokhttp3_internal_http2_ErrorCode_Handler:Okhttp3.Internal.Http2.IPushObserverInvoker, AndriodBinding")]
	...
	internal partial class IPushObserverInvoker : global::Java.Lang.Object, IPushObserver {
		...
		static IntPtr java_class_ref = JNIEnv.FindClass ("okhttp3/internal/http2/PushObserver");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IPushObserverInvoker); }
		}
...
#pragma warning disable 0169
		static Delegate GetOnHeaders_ILjava_util_List_ZHandler ()
		{
			if (cb_onHeaders_ILjava_util_List_Z == null)
				cb_onHeaders_ILjava_util_List_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPILZ_Z) n_OnHeaders_ILjava_util_List_Z);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.IPushObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public unsafe bool OnHeaders (int p0, global::System.Collections.Generic.IList<global::Okhttp3.Internal.Http2.Header> p1, bool p2)
		{
			...
			var __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_onHeaders_ILjava_util_List_Z, __args);
...
#pragma warning disable 0169
		static Delegate GetOnRequest_ILjava_util_List_Handler ()
		{
			if (cb_onRequest_ILjava_util_List_ == null)
				cb_onRequest_ILjava_util_List_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPIL_Z) n_OnRequest_ILjava_util_List_);
...
#pragma warning restore 0169
		...
		public unsafe bool OnRequest (int p0, global::System.Collections.Generic.IList<global::Okhttp3.Internal.Http2.Header> p1)
		{
			...
			__args [0] = new JValue (p0);
			__args [1] = new JValue (native_p1);
			var __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_onRequest_ILjava_util_List_, __args);
			JNIEnv.DeleteLocalRef (native_p1);
			return __ret;
		}
...
#pragma warning disable 0169
		static Delegate GetOnReset_ILokhttp3_internal_http2_ErrorCode_Handler ()
		{
			if (cb_onReset_ILokhttp3_internal_http2_ErrorCode_ == null)
				cb_onReset_ILokhttp3_internal_http2_ErrorCode_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPIL_V) n_OnReset_ILokhttp3_internal_http2_ErrorCode_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.IPushObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var p1 = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.ErrorCode> (native_p1, JniHandleOwnership.DoNotTransfer);
