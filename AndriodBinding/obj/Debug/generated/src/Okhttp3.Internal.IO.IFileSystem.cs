...
namespace Okhttp3.Internal.IO {
		...
		public static global::Okhttp3.Internal.IO.IFileSystem System {
			get {
				if (SYSTEM_jfieldId == IntPtr.Zero)
					SYSTEM_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "SYSTEM", "Lokhttp3/internal/io/FileSystem;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, SYSTEM_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.IO.IFileSystem> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}

		new static IntPtr class_ref = JNIEnv.FindClass ("okhttp3/internal/io/FileSystem");
	}
	...
	public partial interface IFileSystem : IJavaObject {
		...
		[Register ("delete", "(Ljava/io/File;)V", "GetDelete_Ljava_io_File_Handler:Okhttp3.Internal.IO.IFileSystemInvoker, AndriodBinding")]
		...
		[Register ("deleteContents", "(Ljava/io/File;)V", "GetDeleteContents_Ljava_io_File_Handler:Okhttp3.Internal.IO.IFileSystemInvoker, AndriodBinding")]
		...
		[Register ("exists", "(Ljava/io/File;)Z", "GetExists_Ljava_io_File_Handler:Okhttp3.Internal.IO.IFileSystemInvoker, AndriodBinding")]
		...
		[Register ("rename", "(Ljava/io/File;Ljava/io/File;)V", "GetRename_Ljava_io_File_Ljava_io_File_Handler:Okhttp3.Internal.IO.IFileSystemInvoker, AndriodBinding")]
		...
		[Register ("size", "(Ljava/io/File;)J", "GetSize_Ljava_io_File_Handler:Okhttp3.Internal.IO.IFileSystemInvoker, AndriodBinding")]
	...
	internal partial class IFileSystemInvoker : global::Java.Lang.Object, IFileSystem {
		...
		static IntPtr java_class_ref = JNIEnv.FindClass ("okhttp3/internal/io/FileSystem");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IFileSystemInvoker); }
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.IO.IFileSystem> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetDeleteContents_Ljava_io_File_Handler ()
		{
			if (cb_deleteContents_Ljava_io_File_ == null)
				cb_deleteContents_Ljava_io_File_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_DeleteContents_Ljava_io_File_);
...
#pragma warning restore 0169
		...
		public unsafe bool Exists (global::Java.IO.File p0)
		{
			...
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue (p0);
			var __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_exists_Ljava_io_File_, __args);
			return __ret;
		}
...
#pragma warning disable 0169
		static Delegate GetRename_Ljava_io_File_Ljava_io_File_Handler ()
		{
			if (cb_rename_Ljava_io_File_Ljava_io_File_ == null)
				cb_rename_Ljava_io_File_Ljava_io_File_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLL_V) n_Rename_Ljava_io_File_Ljava_io_File_);
...
#pragma warning disable 0169
		static Delegate GetSize_Ljava_io_File_Handler ()
		{
			if (cb_size_Ljava_io_File_ == null)
				cb_size_Ljava_io_File_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_J) n_Size_Ljava_io_File_);
...
#pragma warning restore 0169
		...
		public unsafe long Size (global::Java.IO.File p0)
		{
			...
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue (p0);
			var __ret = JNIEnv.CallLongMethod (((global::Java.Lang.Object) this).Handle, id_size_Ljava_io_File_, __args);
			return __ret;
		}
