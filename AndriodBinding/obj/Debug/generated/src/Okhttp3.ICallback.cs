...
namespace Okhttp3 {
	...
	public partial interface ICallback : IJavaObject {
		...
		[Register ("onFailure", "(Lokhttp3/Call;Ljava/io/IOException;)V", "GetOnFailure_Lokhttp3_Call_Ljava_io_IOException_Handler:Okhttp3.ICallbackInvoker, AndriodBinding")]
		...
		[Register ("onResponse", "(Lokhttp3/Call;Lokhttp3/Response;)V", "GetOnResponse_Lokhttp3_Call_Lokhttp3_Response_Handler:Okhttp3.ICallbackInvoker, AndriodBinding")]
	...
	internal partial class ICallbackInvoker : global::Java.Lang.Object, ICallback {
		...
		static IntPtr java_class_ref = JNIEnv.FindClass ("okhttp3/Callback");
...
#pragma warning disable 0169
		static Delegate GetOnFailure_Lokhttp3_Call_Ljava_io_IOException_Handler ()
		{
			if (cb_onFailure_Lokhttp3_Call_Ljava_io_IOException_ == null)
				cb_onFailure_Lokhttp3_Call_Ljava_io_IOException_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLL_V) n_OnFailure_Lokhttp3_Call_Ljava_io_IOException_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.ICallback> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetOnResponse_Lokhttp3_Call_Lokhttp3_Response_Handler ()
		{
			if (cb_onResponse_Lokhttp3_Call_Lokhttp3_Response_ == null)
				cb_onResponse_Lokhttp3_Call_Lokhttp3_Response_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLL_V) n_OnResponse_Lokhttp3_Call_Lokhttp3_Response_);
