	...
	public sealed partial class JsonObject : global::Com.Google.Gson.JsonElement {
		...
		public unsafe void Add (string property, global::Com.Google.Gson.JsonElement value)
		{
			...
			try {
				...
				__args [0] = new JValue (native_property);
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.gson']/class[@name='JsonObject']/method[@name='deepCopy' and count(parameter)=0]"
		[Register ("deepCopy", "()Lcom/google/gson/JsonObject;", "")]
		public unsafe global::Com.Google.Gson.JsonObject DeepCopy ()
		{
			if (id_deepCopy == IntPtr.Zero)
				id_deepCopy = JNIEnv.GetMethodID (class_ref, "deepCopy", "()Lcom/google/gson/JsonObject;");
			try {
				return global::Java.Lang.Object.GetObject<global::Com.Google.Gson.JsonObject> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_deepCopy), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Google.Gson.JsonElement Get (string memberName)
		{
			...
			try {
				...
				__args [0] = new JValue (native_memberName);
