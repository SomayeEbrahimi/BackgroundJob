...
namespace Okhttp3 {
	...
	public partial interface IConnection : IJavaObject {
		...
		[Register ("handshake", "()Lokhttp3/Handshake;", "GetHandshakeHandler:Okhttp3.IConnectionInvoker, AndriodBinding")]
		...
		[Register ("protocol", "()Lokhttp3/Protocol;", "GetProtocolHandler:Okhttp3.IConnectionInvoker, AndriodBinding")]
		...
		[Register ("route", "()Lokhttp3/Route;", "GetRouteHandler:Okhttp3.IConnectionInvoker, AndriodBinding")]
		...
		[Register ("socket", "()Ljava/net/Socket;", "GetSocketHandler:Okhttp3.IConnectionInvoker, AndriodBinding")]
	...
	internal partial class IConnectionInvoker : global::Java.Lang.Object, IConnection {
		...
		static IntPtr java_class_ref = JNIEnv.FindClass ("okhttp3/Connection");
...
#pragma warning disable 0169
		static Delegate GetHandshakeHandler ()
		{
			if (cb_handshake == null)
				cb_handshake = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Handshake);
			return cb_handshake;
		}

		static IntPtr n_Handshake (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.IConnection> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		{
			if (cb_protocol == null)
				cb_protocol = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Protocol);
			return cb_protocol;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_route == null)
				cb_route = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Route);
			return cb_route;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_socket == null)
				cb_socket = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Socket);
			return cb_socket;
		}
