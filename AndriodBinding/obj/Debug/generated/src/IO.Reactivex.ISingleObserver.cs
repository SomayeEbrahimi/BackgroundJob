...
namespace IO.Reactivex {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='io.reactivex']/interface[@name='SingleObserver']"
	[Register ("io/reactivex/SingleObserver", "", "IO.Reactivex.ISingleObserverInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public partial interface ISingleObserver : IJavaObject {
		...
		[Register ("onError", "(Ljava/lang/Throwable;)V", "GetOnError_Ljava_lang_Throwable_Handler:IO.Reactivex.ISingleObserverInvoker, AndriodBinding")]
		void OnError (global::Java.Lang.Throwable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='SingleObserver']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
		[Register ("onSubscribe", "(Lio/reactivex/disposables/Disposable;)V", "GetOnSubscribe_Lio_reactivex_disposables_Disposable_Handler:IO.Reactivex.ISingleObserverInvoker, AndriodBinding")]
		void OnSubscribe (global::IO.Reactivex.Disposables.IDisposable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='SingleObserver']/method[@name='onSuccess' and count(parameter)=1 and parameter[1][@type='T']]"
		[Register ("onSuccess", "(Ljava/lang/Object;)V", "GetOnSuccess_Ljava_lang_Object_Handler:IO.Reactivex.ISingleObserverInvoker, AndriodBinding")]
		void OnSuccess (global::Java.Lang.Object p0);

	}

	[global::Android.Runtime.Register ("io/reactivex/SingleObserver", DoNotGenerateAcw=true)]
	internal partial class ISingleObserverInvoker : global::Java.Lang.Object, ISingleObserver {

		static IntPtr java_class_ref = JNIEnv.FindClass ("io/reactivex/SingleObserver");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ISingleObserverInvoker); }
		}

		IntPtr class_ref;

		public static ISingleObserver GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ISingleObserver> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "io.reactivex.SingleObserver"));
			return handle;
		}
		...
		public ISingleObserverInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.ISingleObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
