...
namespace IO.Reactivex.Internal.Observers {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.internal.observers']/class[@name='BasicQueueDisposable']"
	[global::Android.Runtime.Register ("io/reactivex/internal/observers/BasicQueueDisposable", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public abstract partial class BasicQueueDisposable : global::Java.Lang.Object, global::IO.Reactivex.Internal.Fuseable.IQueueDisposable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/internal/observers/BasicQueueDisposable", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BasicQueueDisposable); }
		}

		protected BasicQueueDisposable (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.internal.observers']/class[@name='BasicQueueDisposable']/constructor[@name='BasicQueueDisposable' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe BasicQueueDisposable ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (BasicQueueDisposable)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.observers']/class[@name='BasicQueueDisposable']/method[@name='offer' and count(parameter)=1 and parameter[1][@type='T']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.observers']/class[@name='BasicQueueDisposable']/method[@name='offer' and count(parameter)=2 and parameter[1][@type='T'] and parameter[2][@type='T']]"
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Internal.Observers.BasicQueueDisposable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Dispose ();
		}
...
#pragma warning restore 0169
		...
		public abstract bool IsDisposed {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.observers']/class[@name='BasicQueueDisposable']/method[@name='isDisposed' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public abstract bool IsEmpty {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.observers']/class[@name='BasicQueueDisposable']/method[@name='isEmpty' and count(parameter)=0]"
	...
	[global::Android.Runtime.Register ("io/reactivex/internal/observers/BasicQueueDisposable", DoNotGenerateAcw=true)]
	internal partial class BasicQueueDisposableInvoker : BasicQueueDisposable, global::IO.Reactivex.Internal.Fuseable.IQueueDisposable, global::IO.Reactivex.Internal.Fuseable.IQueueFuseable, global::IO.Reactivex.Internal.Fuseable.ISimpleQueue {

		public BasicQueueDisposableInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (BasicQueueDisposableInvoker); }
		}
