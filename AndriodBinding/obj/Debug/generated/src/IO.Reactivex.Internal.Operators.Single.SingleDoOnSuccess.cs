...
namespace IO.Reactivex.Internal.Operators.Single {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.internal.operators.single']/class[@name='SingleDoOnSuccess']"
	[global::Android.Runtime.Register ("io/reactivex/internal/operators/single/SingleDoOnSuccess", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public sealed partial class SingleDoOnSuccess : global::IO.Reactivex.Single {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/internal/operators/single/SingleDoOnSuccess", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SingleDoOnSuccess); }
		}

		internal SingleDoOnSuccess (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lio_reactivex_SingleSource_Lio_reactivex_functions_Consumer_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.internal.operators.single']/class[@name='SingleDoOnSuccess']/constructor[@name='SingleDoOnSuccess' and count(parameter)=2 and parameter[1][@type='io.reactivex.SingleSource&lt;T&gt;'] and parameter[2][@type='io.reactivex.functions.Consumer&lt;? super T&gt;']]"
		[Register (".ctor", "(Lio/reactivex/SingleSource;Lio/reactivex/functions/Consumer;)V", "")]
		public unsafe SingleDoOnSuccess (global::IO.Reactivex.ISingleSource source, global::IO.Reactivex.Functions.IConsumer onSuccess)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [1] = new JValue (onSuccess);
				if (((object) this).GetType () != typeof (SingleDoOnSuccess)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.operators.single']/class[@name='SingleDoOnSuccess']/method[@name='subscribeActual' and count(parameter)=1 and parameter[1][@type='io.reactivex.SingleObserver&lt;? super T&gt;']]"
