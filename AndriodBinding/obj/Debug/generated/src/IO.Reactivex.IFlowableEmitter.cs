...
namespace IO.Reactivex {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']"
	[Register ("io/reactivex/FlowableEmitter", "", "IO.Reactivex.IFlowableEmitterInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public partial interface IFlowableEmitter : global::IO.Reactivex.IEmitter {

		bool IsCancelled {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']/method[@name='isCancelled' and count(parameter)=0]"
			[Register ("isCancelled", "()Z", "GetIsCancelledHandler:IO.Reactivex.IFlowableEmitterInvoker, AndriodBinding")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']/method[@name='requested' and count(parameter)=0]"
		[Register ("requested", "()J", "GetRequestedHandler:IO.Reactivex.IFlowableEmitterInvoker, AndriodBinding")]
		long Requested ();

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']/method[@name='serialize' and count(parameter)=0]"
		[Register ("serialize", "()Lio/reactivex/FlowableEmitter;", "GetSerializeHandler:IO.Reactivex.IFlowableEmitterInvoker, AndriodBinding")]
		global::IO.Reactivex.IFlowableEmitter Serialize ();

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']/method[@name='setCancellable' and count(parameter)=1 and parameter[1][@type='io.reactivex.functions.Cancellable']]"
		[Register ("setCancellable", "(Lio/reactivex/functions/Cancellable;)V", "GetSetCancellable_Lio_reactivex_functions_Cancellable_Handler:IO.Reactivex.IFlowableEmitterInvoker, AndriodBinding")]
		void SetCancellable (global::IO.Reactivex.Functions.ICancellable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']/method[@name='setDisposable' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
		[Register ("setDisposable", "(Lio/reactivex/disposables/Disposable;)V", "GetSetDisposable_Lio_reactivex_disposables_Disposable_Handler:IO.Reactivex.IFlowableEmitterInvoker, AndriodBinding")]
		void SetDisposable (global::IO.Reactivex.Disposables.IDisposable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='FlowableEmitter']/method[@name='tryOnError' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register ("tryOnError", "(Ljava/lang/Throwable;)Z", "GetTryOnError_Ljava_lang_Throwable_Handler:IO.Reactivex.IFlowableEmitterInvoker, AndriodBinding")]
		bool TryOnError (global::Java.Lang.Throwable p0);

	}

	[global::Android.Runtime.Register ("io/reactivex/FlowableEmitter", DoNotGenerateAcw=true)]
	internal partial class IFlowableEmitterInvoker : global::Java.Lang.Object, IFlowableEmitter {

		static IntPtr java_class_ref = JNIEnv.FindClass ("io/reactivex/FlowableEmitter");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IFlowableEmitterInvoker); }
		}

		IntPtr class_ref;

		public static IFlowableEmitter GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IFlowableEmitter> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "io.reactivex.FlowableEmitter"));
			return handle;
		}
		...
		public IFlowableEmitterInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.IFlowableEmitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		IntPtr id_serialize;
		public unsafe global::IO.Reactivex.IFlowableEmitter Serialize ()
		{
			if (id_serialize == IntPtr.Zero)
				id_serialize = JNIEnv.GetMethodID (class_ref, "serialize", "()Lio/reactivex/FlowableEmitter;");
			return global::Java.Lang.Object.GetObject<global::IO.Reactivex.IFlowableEmitter> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_serialize), JniHandleOwnership.TransferLocalRef);
		}
