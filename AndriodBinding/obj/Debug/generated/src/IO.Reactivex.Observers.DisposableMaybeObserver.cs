...
namespace IO.Reactivex.Observers {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableMaybeObserver']"
	[global::Android.Runtime.Register ("io/reactivex/observers/DisposableMaybeObserver", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public abstract partial class DisposableMaybeObserver : global::Java.Lang.Object, global::IO.Reactivex.IMaybeObserver, global::IO.Reactivex.Disposables.IDisposable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/observers/DisposableMaybeObserver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DisposableMaybeObserver); }
		}

		protected DisposableMaybeObserver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableMaybeObserver']/constructor[@name='DisposableMaybeObserver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DisposableMaybeObserver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (DisposableMaybeObserver)) {
					SetHandle (
		...
		public unsafe bool IsDisposed {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableMaybeObserver']/method[@name='isDisposed' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableMaybeObserver']/method[@name='dispose' and count(parameter)=0]"
		[Register ("dispose", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Observers.DisposableMaybeObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnStart ();
		}
#pragma warning restore 0169

		static IntPtr id_onStart;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableMaybeObserver']/method[@name='onStart' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='DisposableMaybeObserver']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
...
#pragma warning restore 0169
	...
	[global::Android.Runtime.Register ("io/reactivex/observers/DisposableMaybeObserver", DoNotGenerateAcw=true)]
	internal partial class DisposableMaybeObserverInvoker : DisposableMaybeObserver, global::IO.Reactivex.IMaybeObserver {

		public DisposableMaybeObserverInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (DisposableMaybeObserverInvoker); }
		}
