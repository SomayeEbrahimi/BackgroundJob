...
namespace IO.Reactivex.Internal.Operators.Single {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.internal.operators.single']/class[@name='SingleResumeNext']"
	[global::Android.Runtime.Register ("io/reactivex/internal/operators/single/SingleResumeNext", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public sealed partial class SingleResumeNext : global::IO.Reactivex.Single {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/internal/operators/single/SingleResumeNext", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SingleResumeNext); }
		}

		internal SingleResumeNext (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lio_reactivex_SingleSource_Lio_reactivex_functions_Function_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.internal.operators.single']/class[@name='SingleResumeNext']/constructor[@name='SingleResumeNext' and count(parameter)=2 and parameter[1][@type='io.reactivex.SingleSource&lt;? extends T&gt;'] and parameter[2][@type='io.reactivex.functions.Function&lt;? super java.lang.Throwable, ? extends io.reactivex.SingleSource&lt;? extends T&gt;&gt;']]"
		[Register (".ctor", "(Lio/reactivex/SingleSource;Lio/reactivex/functions/Function;)V", "")]
		public unsafe SingleResumeNext (global::IO.Reactivex.ISingleSource source, global::IO.Reactivex.Functions.IFunction nextFunction)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [1] = new JValue (nextFunction);
				if (((object) this).GetType () != typeof (SingleResumeNext)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.operators.single']/class[@name='SingleResumeNext']/method[@name='subscribeActual' and count(parameter)=1 and parameter[1][@type='io.reactivex.SingleObserver&lt;? super T&gt;']]"
