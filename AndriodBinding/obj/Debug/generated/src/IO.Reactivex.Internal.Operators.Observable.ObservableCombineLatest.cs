...
namespace IO.Reactivex.Internal.Operators.Observable {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.internal.operators.observable']/class[@name='ObservableCombineLatest']"
	[global::Android.Runtime.Register ("io/reactivex/internal/operators/observable/ObservableCombineLatest", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T", "R"})]
	public sealed partial class ObservableCombineLatest : global::IO.Reactivex.Observable {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/internal/operators/observable/ObservableCombineLatest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ObservableCombineLatest); }
		}

		internal ObservableCombineLatest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayLio_reactivex_ObservableSource_Ljava_lang_Iterable_Lio_reactivex_functions_Function_IZ;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.internal.operators.observable']/class[@name='ObservableCombineLatest']/constructor[@name='ObservableCombineLatest' and count(parameter)=5 and parameter[1][@type='io.reactivex.ObservableSource&lt;? extends T&gt;[]'] and parameter[2][@type='java.lang.Iterable&lt;? extends io.reactivex.ObservableSource&lt;? extends T&gt;&gt;'] and parameter[3][@type='io.reactivex.functions.Function&lt;? super java.lang.Object[], ? extends R&gt;'] and parameter[4][@type='int'] and parameter[5][@type='boolean']]"
		[Register (".ctor", "([Lio/reactivex/ObservableSource;Ljava/lang/Iterable;Lio/reactivex/functions/Function;IZ)V", "")]
		public unsafe ObservableCombineLatest (global::IO.Reactivex.IObservableSource[] sources, global::Java.Lang.IIterable sourcesIterable, global::IO.Reactivex.Functions.IFunction combiner, int bufferSize, bool delayError)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ObservableCombineLatest)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.internal.operators.observable']/class[@name='ObservableCombineLatest']/method[@name='subscribeActual' and count(parameter)=1 and parameter[1][@type='io.reactivex.Observer&lt;? super R&gt;']]"
