...
namespace IO.Reactivex.Observers {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']"
	[global::Android.Runtime.Register ("io/reactivex/observers/ResourceCompletableObserver", DoNotGenerateAcw=true)]
	public abstract partial class ResourceCompletableObserver : global::Java.Lang.Object, global::IO.Reactivex.ICompletableObserver, global::IO.Reactivex.Disposables.IDisposable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/observers/ResourceCompletableObserver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ResourceCompletableObserver); }
		}

		protected ResourceCompletableObserver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']/constructor[@name='ResourceCompletableObserver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ResourceCompletableObserver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ResourceCompletableObserver)) {
					SetHandle (
		...
		public unsafe bool IsDisposed {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']/method[@name='isDisposed' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']/method[@name='add' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']/method[@name='dispose' and count(parameter)=0]"
		[Register ("dispose", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Observers.ResourceCompletableObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnStart ();
		}
#pragma warning restore 0169

		static IntPtr id_onStart;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']/method[@name='onStart' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceCompletableObserver']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
...
#pragma warning restore 0169
	...
	[global::Android.Runtime.Register ("io/reactivex/observers/ResourceCompletableObserver", DoNotGenerateAcw=true)]
	internal partial class ResourceCompletableObserverInvoker : ResourceCompletableObserver {

		public ResourceCompletableObserverInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (ResourceCompletableObserverInvoker); }
		}
