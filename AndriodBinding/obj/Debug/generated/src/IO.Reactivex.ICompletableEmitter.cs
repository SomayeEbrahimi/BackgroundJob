...
namespace IO.Reactivex {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']"
	[Register ("io/reactivex/CompletableEmitter", "", "IO.Reactivex.ICompletableEmitterInvoker")]
	public partial interface ICompletableEmitter : IJavaObject {

		bool IsDisposed {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']/method[@name='isDisposed' and count(parameter)=0]"
			[Register ("isDisposed", "()Z", "GetIsDisposedHandler:IO.Reactivex.ICompletableEmitterInvoker, AndriodBinding")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']/method[@name='onComplete' and count(parameter)=0]"
		[Register ("onComplete", "()V", "GetOnCompleteHandler:IO.Reactivex.ICompletableEmitterInvoker, AndriodBinding")]
		void OnComplete ();

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']/method[@name='onError' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register ("onError", "(Ljava/lang/Throwable;)V", "GetOnError_Ljava_lang_Throwable_Handler:IO.Reactivex.ICompletableEmitterInvoker, AndriodBinding")]
		void OnError (global::Java.Lang.Throwable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']/method[@name='setCancellable' and count(parameter)=1 and parameter[1][@type='io.reactivex.functions.Cancellable']]"
		[Register ("setCancellable", "(Lio/reactivex/functions/Cancellable;)V", "GetSetCancellable_Lio_reactivex_functions_Cancellable_Handler:IO.Reactivex.ICompletableEmitterInvoker, AndriodBinding")]
		void SetCancellable (global::IO.Reactivex.Functions.ICancellable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']/method[@name='setDisposable' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
		[Register ("setDisposable", "(Lio/reactivex/disposables/Disposable;)V", "GetSetDisposable_Lio_reactivex_disposables_Disposable_Handler:IO.Reactivex.ICompletableEmitterInvoker, AndriodBinding")]
		void SetDisposable (global::IO.Reactivex.Disposables.IDisposable p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex']/interface[@name='CompletableEmitter']/method[@name='tryOnError' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register ("tryOnError", "(Ljava/lang/Throwable;)Z", "GetTryOnError_Ljava_lang_Throwable_Handler:IO.Reactivex.ICompletableEmitterInvoker, AndriodBinding")]
		bool TryOnError (global::Java.Lang.Throwable p0);

	}

	[global::Android.Runtime.Register ("io/reactivex/CompletableEmitter", DoNotGenerateAcw=true)]
	internal partial class ICompletableEmitterInvoker : global::Java.Lang.Object, ICompletableEmitter {

		static IntPtr java_class_ref = JNIEnv.FindClass ("io/reactivex/CompletableEmitter");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ICompletableEmitterInvoker); }
		}

		IntPtr class_ref;

		public static ICompletableEmitter GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ICompletableEmitter> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "io.reactivex.CompletableEmitter"));
			return handle;
		}
		...
		public ICompletableEmitterInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.ICompletableEmitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
