...
namespace IO.Reactivex.Observers {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']"
	[global::Android.Runtime.Register ("io/reactivex/observers/ResourceMaybeObserver", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public abstract partial class ResourceMaybeObserver : global::Java.Lang.Object, global::IO.Reactivex.IMaybeObserver, global::IO.Reactivex.Disposables.IDisposable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/reactivex/observers/ResourceMaybeObserver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ResourceMaybeObserver); }
		}

		protected ResourceMaybeObserver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']/constructor[@name='ResourceMaybeObserver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ResourceMaybeObserver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ResourceMaybeObserver)) {
					SetHandle (
		...
		public unsafe bool IsDisposed {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']/method[@name='isDisposed' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']/method[@name='add' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']/method[@name='dispose' and count(parameter)=0]"
		[Register ("dispose", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Reactivex.Observers.ResourceMaybeObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnStart ();
		}
#pragma warning restore 0169

		static IntPtr id_onStart;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']/method[@name='onStart' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.reactivex.observers']/class[@name='ResourceMaybeObserver']/method[@name='onSubscribe' and count(parameter)=1 and parameter[1][@type='io.reactivex.disposables.Disposable']]"
...
#pragma warning restore 0169
	...
	[global::Android.Runtime.Register ("io/reactivex/observers/ResourceMaybeObserver", DoNotGenerateAcw=true)]
	internal partial class ResourceMaybeObserverInvoker : ResourceMaybeObserver, global::IO.Reactivex.IMaybeObserver {

		public ResourceMaybeObserverInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (ResourceMaybeObserverInvoker); }
		}
