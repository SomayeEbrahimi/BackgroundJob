...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Request {
	...
	public partial class CharacterWriteReliable : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.BaseIORequest {
		...
		public partial interface ICharacterWriteReliableListener : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IRequestCallback {
			...
			[Register ("onComplete", "(Landroid/bluetooth/BluetoothGattCharacteristic;I[B)V", "GetOnComplete_Landroid_bluetooth_BluetoothGattCharacteristic_IarrayBHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Request.CharacterWriteReliable/ICharacterWriteReliableListenerInvoker, AndriodBinding")]
		...
		internal partial class ICharacterWriteReliableListenerInvoker : global::Java.Lang.Object, ICharacterWriteReliableListener {
			...
			static IntPtr java_class_ref = JNIEnv.FindClass ("com/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener");
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (ICharacterWriteReliableListenerInvoker); }
			}
...
#pragma warning restore 0169
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CharacterWriteReliable); }
		}

		protected CharacterWriteReliable (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB;
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CharacterWriteReliable)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener;Ljava/util/UUID;Ljava/util/UUID;[B)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener;Ljava/util/UUID;Ljava/util/UUID;[B)V", __args);
					return;
				}

				if (id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB == IntPtr.Zero)
					id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener;Ljava/util/UUID;Ljava/util/UUID;[B)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB, __args);
			} finally {
		...
		static IntPtr id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB;
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [2] = new JValue (service);
				__args [3] = new JValue (character);
				__args [4] = new JValue (native_value);
				if (((object) this).GetType () != typeof (CharacterWriteReliable)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener;Ljava/util/UUID;Ljava/util/UUID;[B)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener;Ljava/util/UUID;Ljava/util/UUID;[B)V", __args);
					return;
				}

				if (id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB == IntPtr.Zero)
					id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/request/CharacterWriteReliable$CharacterWriteReliableListener;Ljava/util/UUID;Ljava/util/UUID;[B)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_request_CharacterWriteReliable_CharacterWriteReliableListener_Ljava_util_UUID_Ljava_util_UUID_arrayB, __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_mac);
				if (value != null) {
					JNIEnv.CopyArray (native_value, value);
