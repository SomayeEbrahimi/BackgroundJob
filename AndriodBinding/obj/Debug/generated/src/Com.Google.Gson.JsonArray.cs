...
namespace Com.Google.Gson {
	...
	public sealed partial class JsonArray : global::Com.Google.Gson.JsonElement, global::Java.Lang.IIterable {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.gson']/class[@name='JsonArray']/method[@name='deepCopy' and count(parameter)=0]"
		[Register ("deepCopy", "()Lcom/google/gson/JsonArray;", "")]
		public unsafe global::Com.Google.Gson.JsonArray DeepCopy ()
		{
			if (id_deepCopy == IntPtr.Zero)
				id_deepCopy = JNIEnv.GetMethodID (class_ref, "deepCopy", "()Lcom/google/gson/JsonArray;");
			try {
				return global::Java.Lang.Object.GetObject<global::Com.Google.Gson.JsonArray> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_deepCopy), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
