...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Request {
	...
	public partial class DescriptorWrite : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.BaseIORequest {
		...
		public partial interface IDescriptorWriteListener : global::Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IRequestCallback {
			...
			[Register ("onComplete", "(Landroid/bluetooth/BluetoothGattDescriptor;I[B)V", "GetOnComplete_Landroid_bluetooth_BluetoothGattDescriptor_IarrayBHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Request.DescriptorWrite/IDescriptorWriteListenerInvoker, AndriodBinding")]
		...
		internal partial class IDescriptorWriteListenerInvoker : global::Java.Lang.Object, IDescriptorWriteListener {
			...
			static IntPtr java_class_ref = JNIEnv.FindClass ("com/vivalnk/sdk/common/ble/connect/request/DescriptorWrite$DescriptorWriteListener");
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (IDescriptorWriteListenerInvoker); }
			}
...
#pragma warning restore 0169
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/vivalnk/sdk/common/ble/connect/request/DescriptorWrite", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DescriptorWrite); }
		}

		protected DescriptorWrite (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_DescriptorWrite_DescriptorWriteListener_Ljava_util_UUID_Ljava_util_UUID_Ljava_util_UUID_arrayB;
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [6] = new JValue (native_value);
				if (((object) this).GetType () != typeof (DescriptorWrite)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/DescriptorWrite$DescriptorWriteListener;Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;[B)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/DescriptorWrite$DescriptorWriteListener;Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;[B)V", __args);
					return;
				}

				if (id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_DescriptorWrite_DescriptorWriteListener_Ljava_util_UUID_Ljava_util_UUID_Ljava_util_UUID_arrayB == IntPtr.Zero)
					id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_DescriptorWrite_DescriptorWriteListener_Ljava_util_UUID_Ljava_util_UUID_Ljava_util_UUID_arrayB = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/String;Lcom/vivalnk/sdk/common/ble/connect/base/IORequestOptions;Lcom/vivalnk/sdk/common/ble/connect/request/DescriptorWrite$DescriptorWriteListener;Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;[B)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_DescriptorWrite_DescriptorWriteListener_Ljava_util_UUID_Ljava_util_UUID_Ljava_util_UUID_arrayB, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_lang_String_Lcom_vivalnk_sdk_common_ble_connect_base_IORequestOptions_Lcom_vivalnk_sdk_common_ble_connect_request_DescriptorWrite_DescriptorWriteListener_Ljava_util_UUID_Ljava_util_UUID_Ljava_util_UUID_arrayB, __args);
			} finally {
