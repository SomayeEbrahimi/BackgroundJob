...
namespace Okhttp3 {
		...
		public static global::Okhttp3.IAuthenticator None {
			get {
				if (NONE_jfieldId == IntPtr.Zero)
					NONE_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "NONE", "Lokhttp3/Authenticator;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, NONE_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.IAuthenticator> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}

		new static IntPtr class_ref = JNIEnv.FindClass ("okhttp3/Authenticator");
	}
	...
	public partial interface IAuthenticator : IJavaObject {
		...
		[Register ("authenticate", "(Lokhttp3/Route;Lokhttp3/Response;)Lokhttp3/Request;", "GetAuthenticate_Lokhttp3_Route_Lokhttp3_Response_Handler:Okhttp3.IAuthenticatorInvoker, AndriodBinding")]
	...
	internal partial class IAuthenticatorInvoker : global::Java.Lang.Object, IAuthenticator {
		...
		static IntPtr java_class_ref = JNIEnv.FindClass ("okhttp3/Authenticator");
...
#pragma warning disable 0169
		static Delegate GetAuthenticate_Lokhttp3_Route_Lokhttp3_Response_Handler ()
		{
			if (cb_authenticate_Lokhttp3_Route_Lokhttp3_Response_ == null)
				cb_authenticate_Lokhttp3_Route_Lokhttp3_Response_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLL_L) n_Authenticate_Lokhttp3_Route_Lokhttp3_Response_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Okhttp3.IAuthenticator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var p0 = global::Java.Lang.Object.GetObject<global::Okhttp3.Route> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public unsafe global::Okhttp3.Request Authenticate (global::Okhttp3.Route p0, global::Okhttp3.Response p1)
		{
			...
			var __ret = global::Java.Lang.Object.GetObject<global::Okhttp3.Request> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_authenticate_Lokhttp3_Route_Lokhttp3_Response_, __args), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
