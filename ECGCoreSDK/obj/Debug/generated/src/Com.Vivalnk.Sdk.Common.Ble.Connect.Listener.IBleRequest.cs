...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Listener {
	...
	public partial interface IBleRequest : IJavaObject, IJavaPeerable {
		...
		[Register ("cancel", "()V", "GetCancelHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IBleRequestInvoker, ECGCoreSDK")]
		void Cancel ();
		...
		[Register ("process", "(Lcom/vivalnk/sdk/common/ble/connect/listener/IBleDispatcher;)V", "GetProcess_Lcom_vivalnk_sdk_common_ble_connect_listener_IBleDispatcher_Handler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IBleRequestInvoker, ECGCoreSDK")]
