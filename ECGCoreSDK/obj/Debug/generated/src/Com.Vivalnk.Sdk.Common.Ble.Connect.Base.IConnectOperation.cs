...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Base {
	...
	public partial interface IConnectOperation : IJavaObject, IJavaPeerable {
		...
		bool IsConnected {
			...
			[Register ("isConnected", "()Z", "GetIsConnectedHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IConnectOperationInvoker, ECGCoreSDK")] get;
		}
		...
		bool IsConnecting {
			...
			[Register ("isConnecting", "()Z", "GetIsConnectingHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IConnectOperationInvoker, ECGCoreSDK")] get;
		}
