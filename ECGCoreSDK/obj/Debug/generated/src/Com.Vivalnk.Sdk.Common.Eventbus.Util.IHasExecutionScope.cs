...
namespace Com.Vivalnk.Sdk.Common.Eventbus.Util {
	...
	public partial interface IHasExecutionScope : IJavaObject, IJavaPeerable {
		...
		global::Java.Lang.Object ExecutionScope {
			...
			[Register ("getExecutionScope", "()Ljava/lang/Object;", "GetGetExecutionScopeHandler:Com.Vivalnk.Sdk.Common.Eventbus.Util.IHasExecutionScopeInvoker, ECGCoreSDK")] get;
			...
			[Register ("setExecutionScope", "(Ljava/lang/Object;)V", "GetSetExecutionScope_Ljava_lang_Object_Handler:Com.Vivalnk.Sdk.Common.Eventbus.Util.IHasExecutionScopeInvoker, ECGCoreSDK")] set;
		}
