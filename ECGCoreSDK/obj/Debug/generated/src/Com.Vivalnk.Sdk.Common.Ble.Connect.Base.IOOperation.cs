...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Base {
	...
	public partial interface IOOperation : IJavaObject, IJavaPeerable {
		...
		[Register ("discoverService", "(Lcom/vivalnk/sdk/common/ble/connect/request/DiscoverService$DiscoverServiceListener;Z)V", "GetDiscoverService_Lcom_vivalnk_sdk_common_ble_connect_request_DiscoverService_DiscoverServiceListener_ZHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IOOperationInvoker, ECGCoreSDK")]
		...
		[Register ("readRemoteRssi", "(Lcom/vivalnk/sdk/common/ble/connect/request/ReadRemoteRssi$ReadRssiListener;Z)V", "GetReadRemoteRssi_Lcom_vivalnk_sdk_common_ble_connect_request_ReadRemoteRssi_ReadRssiListener_ZHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IOOperationInvoker, ECGCoreSDK")]
		...
		[Register ("requestMtu", "(ILcom/vivalnk/sdk/common/ble/connect/request/MtuRequest$MtuListener;Z)V", "GetRequestMtu_ILcom_vivalnk_sdk_common_ble_connect_request_MtuRequest_MtuListener_ZHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Base.IOOperationInvoker, ECGCoreSDK")]
