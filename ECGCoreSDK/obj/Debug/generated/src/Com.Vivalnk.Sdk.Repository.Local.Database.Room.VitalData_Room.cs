...
namespace Com.Vivalnk.Sdk.Repository.Local.Database.Room {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']"
	[global::Android.Runtime.Register ("com/vivalnk/sdk/repository/local/database/room/VitalData_Room", DoNotGenerateAcw=true)]
	public partial class VitalData_Room : global::Com.Vivalnk.Sdk.Model.Common.IVitalData, global::Java.IO.ISerializable {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/vivalnk/sdk/repository/local/database/room/VitalData_Room", typeof (VitalData_Room));
		...
		protected VitalData_Room (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/constructor[@name='VitalData_Room' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe VitalData_Room ()
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/constructor[@name='VitalData_Room' and count(parameter)=1 and parameter[1][@type='com.vivalnk.sdk.data.DataJsonConverter.DataFormated']]"
		[Register (".ctor", "(Lcom/vivalnk/sdk/data/DataJsonConverter$DataFormated;)V", "")]
		public unsafe VitalData_Room (global::Com.Vivalnk.Sdk.Data.DataJsonConverter.DataFormated p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/constructor[@name='VitalData_Room' and count(parameter)=1 and parameter[1][@type='com.vivalnk.sdk.model.common.IVitalData']]"
		[Register (".ctor", "(Lcom/vivalnk/sdk/model/common/IVitalData;)V", "")]
		public unsafe VitalData_Room (global::Com.Vivalnk.Sdk.Model.Common.IVitalData p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Vivalnk.Sdk.Repository.Local.Database.Room.VitalData_Room> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override unsafe string DeviceID {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getDeviceID' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setDeviceID' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public override unsafe global::Com.Vivalnk.Sdk.Model.DeviceModel DeviceModel {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getDeviceModel' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setDeviceModel' and count(parameter)=1 and parameter[1][@type='com.vivalnk.sdk.model.DeviceModel']]"
...
#pragma warning restore 0169
		...
		public override unsafe string DeviceName {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getDeviceName' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setDeviceName' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public override unsafe string DeviceSN {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getDeviceSN' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setDeviceSN' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public override unsafe global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> Extras {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getExtras' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setExtras' and count(parameter)=1 and parameter[1][@type='java.util.Map&lt;java.lang.String, java.lang.Object&gt;']]"
...
#pragma warning restore 0169
		...
		public override unsafe long Id {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setId' and count(parameter)=1 and parameter[1][@type='long']]"
...
#pragma warning restore 0169
		...
		public override unsafe global::Java.Lang.Long Time {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='getTime' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='setTime' and count(parameter)=1 and parameter[1][@type='java.lang.Long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.vivalnk.sdk.repository.local.database.room']/class[@name='VitalData_Room']/method[@name='clone' and count(parameter)=0]"
		[Register ("clone", "()Lcom/vivalnk/sdk/repository/local/database/room/VitalData_Room;", "GetCloneHandler")]
		public virtual unsafe global::Com.Vivalnk.Sdk.Repository.Local.Database.Room.VitalData_Room Clone ()
		{
			const string __id = "clone.()Lcom/vivalnk/sdk/repository/local/database/room/VitalData_Room;";
			try {
				var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, null);
