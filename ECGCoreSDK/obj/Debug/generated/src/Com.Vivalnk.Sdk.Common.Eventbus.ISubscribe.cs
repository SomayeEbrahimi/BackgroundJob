...
namespace Com.Vivalnk.Sdk.Common.Eventbus {
	...
	public partial interface ISubscribe : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("priority", "()I", "GetPriorityHandler:Com.Vivalnk.Sdk.Common.Eventbus.ISubscribeInvoker, ECGCoreSDK")]
		int Priority ();
		...
		[Register ("sticky", "()Z", "GetStickyHandler:Com.Vivalnk.Sdk.Common.Eventbus.ISubscribeInvoker, ECGCoreSDK")]
		bool Sticky ();
		...
		[Register ("threadMode", "()Lcom/vivalnk/sdk/common/eventbus/ThreadMode;", "GetThreadModeHandler:Com.Vivalnk.Sdk.Common.Eventbus.ISubscribeInvoker, ECGCoreSDK")]
