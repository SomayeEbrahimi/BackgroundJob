...
namespace Com.Vivalnk.Sdk.Common.Ble.Connect.Listener {
	...
	public partial interface IDispatchCallback : IJavaObject, IJavaPeerable {
		...
		[Register ("finishRequest", "()V", "GetFinishRequestHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IDispatchCallbackInvoker, ECGCoreSDK")]
		void FinishRequest ();
		...
		[Register ("onError", "(ILjava/lang/String;)V", "GetOnError_ILjava_lang_String_Handler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IDispatchCallbackInvoker, ECGCoreSDK")]
		...
		[Register ("onStart", "()V", "GetOnStartHandler:Com.Vivalnk.Sdk.Common.Ble.Connect.Listener.IDispatchCallbackInvoker, ECGCoreSDK")]
		void OnStart ();
